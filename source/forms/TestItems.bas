        ...
        Begin FormHeader
            ...
            Begin
                ...
                Begin TextBox
                    ...
                    ForeColor =4210752
                    Name ="txtPrefix"
                    ControlSource ="=TestsGetCurrentPrefix()"
                    GridlineColor =10921638
                ...
                Begin Label
                    ...
                    Name ="lblNullString"
                    Caption ="{NULLSTRING}"
                    OnClick ="=SetParam(\"{NULLSTRING}\",True)"
                    GridlineColor =10921638
                    LayoutCachedLeft =2400
                    LayoutCachedTop =765
...
Private Sub cmdChangePrefix_Click()
    On Error Resume Next
    
    TestsSetCurrentPrefix InputBox("Enter new tests prefix:", "Tests", TestsGetCurrentPrefix())
    txtPrefix.Requery
...
Private Sub ClearList()
    ...
    While Err.Number = 0 And lstMessages.ListCount > 0
        lstMessages.RemoveItem 0
    Wend
...
Private Function ContinuousUpDownOk() As Boolean
    ...
    If ctl.Section = acDetail Then
        ...
        ElseIf TypeOf ctl Is ComboBox Or TypeOf ctl Is ListBox Then
            ' / sort of kludgy -- would rather detect if the box is open!
            bDontDoIt = True
        End If
    Else
        bDontDoIt = True
...
Public Function SetParam(sParam As String, bReplaceAll As Boolean)
    On Error Resume Next
    If Left(Screen.ActiveControl.Name, 5) = "Param" Then
        If bReplaceAll Then
            Screen.ActiveControl.Text = sParam
        Else
            Screen.ActiveControl.SelText = sParam
        End If
    End If
End Function
...
Private Sub TestGroup_GotFocus()
    ' TODO: What? This seems like default behavior already!
    'test_SelectAll TestGroup
End Sub

Private Sub test_SelectAll(ctl As Control)
    On Error Resume Next
    'ctl.SelStart = 0: ctl.SelLength = Len(ctl.Value)
End Sub
